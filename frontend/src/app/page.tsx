...
export default function Home() {
  ...
  return (
    <main className='min-h-screen flex justify-center bg-gradient-to-br from-slate-50 via-purple-50/30 to-blue-50/30 dark:from-slate-900 dark:via-purple-900/30 dark:to-blue-900/30'>
      {/* Main Content */}
      <section className='flex-1 max-w-3xl overflow-y-auto' ref={mainRef}>
        <div className='w-full p-4 pt-10'>
          {/* Form Create Todo List */}
          <div className='backdrop-blur-xl bg-white/80 dark:bg-slate-900/80 rounded-2xl shadow-glass-lg border border-white/20 dark:border-white/10 p-6 mb-6'>
            <div className='relative px-0 pb-5 border-b border-slate-200/50 dark:border-slate-700/50'>
              <div className='grid gap-4'>
                <div className='flex items-center gap-2'>
                  <h1 className='text-2xl font-semibold text-slate-900 dark:text-white'>Create a Todo List</h1>
          ...
          {/* Trending Tags */}
          <div className='backdrop-blur-xl bg-white/80 dark:bg-slate-900/80 rounded-2xl shadow-glass-lg border border-white/20 dark:border-white/10 p-6 mb-6'>
            <h2 className='text-lg font-semibold mb-4 text-slate-700 dark:text-slate-200'>Trending Tags</h2>
          ...
          <div className='flex flex-col md:flex-row md:items-center gap-2 mb-6'>
            <div className='flex-1'>
              <input type='text' value={search} onChange={(e) => setSearch(e.target.value)} placeholder='Cari todo list...' className='w-full px-4 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500/50 dark:focus:ring-blue-400/50' />
            </div>
          </div>
