        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-blue-50/30 dark:from-slate-900 dark:via-purple-900/30 dark:to-blue-900/30">
            ...
            <div className="relative min-h-screen grid place-items-center p-4">
                <div className="w-full max-w-3xl backdrop-blur-xl bg-white/80 dark:bg-slate-900/80 rounded-2xl shadow-glass-lg border border-white/20 dark:border-white/10 p-6">
                    <h1 className="text-3xl font-bold text-center mb-8 bg-gradient-to-r from-slate-900 to-slate-600 dark:from-white dark:to-slate-400 bg-clip-text text-transparent">
                        Create a Shareable Todo List
                    </h1>
                    
                    {error && (
                        <div className="bg-red-50/80 dark:bg-red-900/30 border border-red-200/50 dark:border-red-700/50 text-red-700 dark:text-red-400 px-4 py-3 rounded-lg mb-4">
                            {error}
                        </div>
                    )}
                    ...
                    <div className="mb-6">
                        ...
                        <select
                            ...
                            className="w-full p-2 bg-white/90 dark:bg-slate-800/90 border border-slate-200/50 dark:border-slate-700/50 text-slate-900 dark:text-slate-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 dark:focus:ring-blue-400/50"
                        >
                        ...
                        {items.map((item, index) => (
                            <div key={index} className="flex items-center mb-2 group">
                                <input
                                    ...
                                    className="mr-2 h-4 w-4 rounded border-slate-300 dark:border-slate-600 text-blue-500 dark:text-blue-400 focus:ring-blue-500/50 dark:focus:ring-blue-400/50"
                                />
                                <input
                                    type="text"
                                    value={item.content}
                                    ...
                                    className="flex-1 p-2 bg-white/90 dark:bg-slate-800/90 border border-slate-200/50 dark:border-slate-700/50 text-slate-900 dark:text-slate-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 dark:focus:ring-blue-400/50"
                                />
                                <button
                                    onClick={() => handleRemoveItem(index)}
                                    className="ml-2 text-slate-400 hover:text-red-500 dark:text-slate-500 dark:hover:text-red-400 opacity-0 group-hover:opacity-100 transition-opacity"
